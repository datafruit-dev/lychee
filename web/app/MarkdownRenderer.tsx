  ...
  return (
    <div className={`markdown-content ${className}`}>
      <ReactMarkdown
        ...
        components={{
          // Style headings
          h1: ({ children }) => <h1 className="font-bold text-lg mb-2 text-gray-900">{children}</h1>,
          h2: ({ children }) => <h2 className="font-semibold text-base mb-2 text-gray-900">{children}</h2>,
          h3: ({ children }) => <h3 className="font-medium text-sm mb-1 text-gray-900">{children}</h3>,

          // Style paragraphs
          p: ({ children }) => <p className="text-[15px] mb-2 text-gray-800 break-words leading-relaxed">{children}</p>,

          // Style lists
          ul: ({ children }) => <ul className="list-disc list-inside text-[15px] mb-2 text-gray-800 space-y-1">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal list-inside text-[15px] mb-2 text-gray-800 space-y-1">{children}</ol>,
          li: ({ children }) => <li className="text-[15px] text-gray-800">{children}</li>,

          // Style links
          a: ({ href, children }) => (
            <a href={href} className="text-[15px] text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">
              {children}
            </a>
          ),
